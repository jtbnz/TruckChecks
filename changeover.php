    ...
    if ($selected_truck_id) {
        ...
        foreach ($results as $row) {
            ...
            if ($prev_locker != $row['locker_name']) {
                ...
                echo "\t<th><strong>" . htmlspecialchars($row['locker_name']) . "</strong></th><th>Relief</th><th>" . htmlspecialchars($row['truck_name']) . "</th><th><strong>" . htmlspecialchars($row['locker_name']) . "</strong></th><th>Relief</th><th>" . htmlspecialchars($row['truck_name']) .  "</th><TR>\n";
